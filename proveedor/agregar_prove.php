...
<html lang="en">
            ...
            <ul class="navbar-nav ms-auto me-0 me-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="register.html">Registrese</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Agregar Proveedor</div>
                                    <center>
                                    <div class="col-md-5">
                                          <h3>Agregar Nuevo Proveedor</h3>
                                              <form action="aceptar_prove.php" method="POST" enctype="multipart/form-data">
                                                     <div>
                                                       <label for="exampleInputid_proveedor" >Codigo Proveedor</label>
                                                       <input type="text" REQUIRED  name="id_proveedor" placeholder="Codigo Proveedor"/>
                                                      </div>
                                                      <div>
                                                   <label for="exampleInputruc_proveedor" >Ruc Proveedor</label>
                                                       <input type="text" REQUIRED   name="ruc_proveedor" placeholder="Ruc Proveedor"/>
                                                   </div>
                                                  <div>
                                                   <label for="exampleInputnombre_proveedor" >Nombre Cliente</label>
                                                       <input type="text" REQUIRED  name="nombre_proveedor" placeholder="Nombre Proveedor"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputapellido_proveedor" >Apellidos</label>
                                                       <input type="text" REQUIRED   name="apellido_proveedor" placeholder="Apellidos"/>
                                                   </div>
  ...
  <td><th><button><a href="actualizar_prove.php?id_proveedor=<?php echo $row['id_proveedor']; ?>">actualizar</a></button> </th>
      <th><button><a href="eliminar_prove.php?id_proveedor=<?php echo $row['id_proveedor']; ?>">eliminar</a></button></th>
