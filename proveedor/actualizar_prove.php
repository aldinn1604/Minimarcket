        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
             ...
             $row = $result->fetch_assoc();
                 ?>
                                              <form action="proceso_actualiza_pro.php?id_proveedor=<?php echo $row['id_proveedor']; ?>" method="POST" enctype="multipart/form-data">  
                                                      <div>
                                                   <label for="exampleInputruc_proveedor" >Ruc Proveedor</label>
                                                       <input type="text" REQUIRED   name="ruc_proveedor" value="<?php echo $row['ruc_proveedor'];?>"/>
                                                   </div>
                                                  <div>
                                                   <label for="exampleInputnombre_proveedor" >Nombre Proveedor</label>
                                                       <input type="text" REQUIRED  name="nombre_proveedor" value="<?php echo $row['nombre_proveedor'];?>"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputapellido_proveedor" >Apellidos</label>
                                                       <input type="text" REQUIRED   name="apellido_proveedor" value="<?php echo $row['apellido_proveedor'];?>"/>
                                                   </div>
                                                    <br>
