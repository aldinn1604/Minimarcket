...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Actualizar Trabajador</div>
                                    <center>
                                    <div class="col-md-5">
                                    <?php
                                    include("../bd/conexion.php");
             $id_trabajador = $_REQUEST['id_trabajador'];
             $query = "SELECT * FROM trabajador where id_trabajador='$id_trabajador'";
             $result = $conexion->query($query);
             $row = $result->fetch_assoc();
                 ?>
                                              <form action="proceso_actualiza_tra.php?id_trabajador=<?php echo $row['id_trabajador']; ?>" method="POST" enctype="multipart/form-data">
                                                  <div>
                                                   <label for="exampleInputnombre_trabajador" >Nombre Trabajador</label>
                                                       <input type="text" REQUIRED  name="nombre_trabajador" value="<?php echo $row['nombre_trabajador'];?>"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputapellido_trabajador" >Apellidos</label>
                                                       <input type="text" REQUIRED   name="apellido_trabajador" value="<?php echo $row['apellido_trabajador'];?>"/>
                                                   </div>
  ...
  <td><?php echo $row['apellido_trabajador'];?></td>
  <td><th><button><a href="actualizar_tra.php?id_trabajador=<?php echo $row['id_trabajador']; ?>">actualizar</a></button> </th>
      <th><button><a href="eliminar_tra.php?id_trabajador=<?php echo $row['id_trabajador']; ?>">eliminar</a></button></th>
