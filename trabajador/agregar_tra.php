                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Agregar Trabajador</div>
                                    <center>
                                    <div class="col-md-5">
                                          <h3>Agregar Nuevo Trabajador</h3>
                                              <form action="aceptar_tra.php" method="POST" enctype="multipart/form-data">
                                                     <div>
                                                       <label for="exampleInputid_trabajador" >Codigo Trabajador</label>
                                                       <input type="text" REQUIRED  name="id_prove" placeholder="Codigo Proveedor"/>
                                                      </div>
                                                  <div>
                                                   <label for="exampleInputnombre_trabajador" >Nombre Trabajador</label>
                                                       <input type="text" REQUIRED  name="nombre_trabajador" placeholder="Nombre Proveedor"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputapellido_trabajador" >Apellidos</label>
                                                       <input type="text" REQUIRED   name="apellido_trabajador" placeholder="Apellidos"/>
                                                   </div>
