...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Agregar Cajero</div>
                                    <center>
                                    <div class="col-md-5">
                                          <h3>Agregar Nuevo Cajero</h3>
                                              <form action="aceptar_caj.php" method="POST" enctype="multipart/form-data">
                                                     <div>
                                                       <label for="exampleInputid_cajero" >Codigo Cajero</label>
                                                       <input type="text" REQUIRED  name="id_cajero" placeholder="Codigo Cajero"/>
                                                      </div>
                                                  <div>
                                                   <label for="exampleInputnombre_cajero" >Nombre Cajero</label>
                                                       <input type="text" REQUIRED  name="nombre_cajero" placeholder="Nombre Cajero"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputapellido_cajero" >Apellidos</label>
                                                       <input type="text" REQUIRED   name="apellido_cajero" placeholder="Apellidos"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputnumero_cajero" >Numero Celular</label>
                                                       <input type="text" REQUIRED   name="numero_cajero" placeholder="numero Celular"/>
                                                   </div>
                                                    <br>
   ...
   <td><?php echo $row['id_cajero'];?></td>
   <td><?php echo $row['nombre_cajero'];?></td>
   <td><?php echo $row['apellido_cajero'];?></td>
   <td><?php echo $row['numero_cajero'];?></td>
   <td><th><button><a href="actualizar_caj.php?id_cajero=<?php echo $row['id_cajero']; ?>">actualizar</a></button> </th>
       <th><button><a href="eliminar_caj.php?id_cajero=<?php echo $row['id_cajero']; ?>">eliminar</a></button></th>
