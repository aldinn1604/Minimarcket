            ...
            <div id="layoutSidenav_content">
             ...
             $row = $result->fetch_assoc();
                 ?>
                                              ...
                                              <form action="proceso_actualiza_caj.php?id_cajero=<?php echo $row['id_cajero']; ?>" method="POST" enctype="multipart/form-data">
                                                  <div>
                                                   <label for="exampleInputnombre_cajero" >Nombre Cajero</label>
                                                       <input type="text" REQUIRED  name="nombre_cajero" value="<?php echo $row['nombre_cajero'];?>"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputapellido_cajero" >Apellidos</label>
                                                       <input type="text" REQUIRED   name="apellido_cajero" value="<?php echo $row['apellido_cajero'];?>"/>
                                                   </div>
                                                   <div>
                                                   <label for="exampleInputnumero_cajero" >Numero Celular</label>
                                                       <input type="text" REQUIRED   name="numero_cajero" value="<?php echo $row['numero_cajero'];?>"/>
                                                   </div>
                                                    <br>
