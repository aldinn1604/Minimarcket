            ...
            <div id="layoutSidenav_content">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body"><h3>Agregar Nueva categoria</h3></div>
                                    <center>
                                    <div class="col-md-5">
                                    <?php
             ...
             $row = $result->fetch_assoc();
                 ?>
                                              ...
                                              <form action="proceso_actualiza_cat.php?id_categoria=<?php echo $row['id_categoria']; ?>" method="POST" enctype="multipart/form-data">
                                                  <div>
                                                   <label for="exampleInputnombre_categoria" >Nombre Categoria</label>
                                                       <input type="text" REQUIRED  name="nombre_categoria" value="<?php echo $row['nombre_categoria'];?>" />
                                                   </div>
                                                    <br>
