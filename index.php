...
echo "<script>console.log('Console: name" . $nombre_usuario . "' );</script>";
$tipo_usuario = $_SESSION['tipo_usuario'];
echo "<script>console.log('Console: tipo" . $tipo_usuario . "' );</script>";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body class="sb-nav-fixed">
           ...
           <!-- <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            ...
            <ul class="navbar-nav ms-auto me-0 me-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo "$nombre_usuario"; ?><i class="fas fa-user fa-fw"></i></a>
        ...
        <div id="layoutSidenav">
         ...
         while($row = $result->fetch_assoc()){
             ?>
                      <div class="index2">
                      <a href="producto/detalle_pro.php?id_producto=<?php echo $row['id_producto']; ?>">
